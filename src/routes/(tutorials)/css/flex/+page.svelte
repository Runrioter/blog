...
<svelte:head>
	...
	<meta name="description" content="CSS Flex" />
</svelte:head>

<h1 class="w-full text-center text-[2rem] font-normal">Flex</h1>

<div class="mx-0 my-auto flex grow-[0.6] flex-col justify-center">
	<header class="h-24 bg-purple-500">
